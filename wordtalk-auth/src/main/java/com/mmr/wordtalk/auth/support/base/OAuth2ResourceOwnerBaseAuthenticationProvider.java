package com.mmr.wordtalk.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.mmr.wordtalk.common.core.constant.CommonConstants;
import com.mmr.wordtalk.common.security.service.WordtalkRedisOAuth2AuthorizationService;
import com.mmr.wordtalk.common.security.util.OAuth2ErrorCodesExpand;
import com.mmr.wordtalk.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			WordtalkRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (WordtalkRedisOAuth2AuthorizationService) this.authorizationService;
