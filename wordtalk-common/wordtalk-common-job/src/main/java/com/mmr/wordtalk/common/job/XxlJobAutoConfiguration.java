package com.mmr.wordtalk.common.job;

import com.mmr.wordtalk.common.job.properties.XxlExecutorProperties;
import com.mmr.wordtalk.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://wordtalk-xxl:9080/xxl-job-admin"
