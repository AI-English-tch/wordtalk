package com.mmr.wordtalk.common.core.config;

import cn.hutool.core.date.DatePattern;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.ser.std.ToStringSerializer;
import com.mmr.wordtalk.common.core.jackson.WordtalkJavaTimeModule;
...
public class JacksonConfiguration implements WebMvcConfigurer {
	...
	public Jackson2ObjectMapperBuilderCustomizer customizer() {
		return builder -> {
			...
			builder.modules(new WordtalkJavaTimeModule());
		};
	}

	/**
	 * 增加GET请求参数中时间类型转换 {@link com.mmr.wordtalk.common.core.jackson.WordtalkJavaTimeModule}
	 * <ul>
