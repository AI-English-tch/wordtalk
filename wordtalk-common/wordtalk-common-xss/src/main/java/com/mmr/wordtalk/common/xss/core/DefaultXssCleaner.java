...
package com.mmr.wordtalk.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.mmr.wordtalk.common.xss.config.WordtalkXssProperties;
import com.mmr.wordtalk.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final WordtalkXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		WordtalkXssProperties.Mode mode = properties.getMode();
		if (WordtalkXssProperties.Mode.escape == mode) {
			// html 转义
