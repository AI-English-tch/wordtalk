...
import com.mmr.wordtalk.app.api.feign.RemoteAppUserService;
...
public class WordtalkTocDefaultUserDetailsServiceImpl implements WordtalkUserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		if (cache != null && cache.get(username) != null) {
			return cache.get(username, WordtalkUser.class);
		}
	...
	UserDetails convertUserDetailsAppUser(AppUserInfo info) {
		...
		return new WordtalkUser(user.getUserId(), user.getUsername(), null, user.getPhone(), user.getAvatar(),
