 ...
 */
@Slf4j
public class WordtalkSentinelInvocationHandler implements InvocationHandler {
	...
	WordtalkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			WordtalkSentinelInvocationHandler other = (WordtalkSentinelInvocationHandler) obj;
