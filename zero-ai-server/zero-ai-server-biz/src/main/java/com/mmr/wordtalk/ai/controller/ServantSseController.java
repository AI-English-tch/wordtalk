...
@Tag(description = "servant-sse", name = "servant中的sse连接管理")
@SecurityRequirement(name = HttpHeaders.AUTHORIZATION)
public class ServantSseController {
    ...
    public SseEmitter open() {
        ...
        return SseEmitterUtil.openEmitter(SystemEnum.SERVANT.getSystem(), username);
    }
    ...
    public R close() {
        String username = SecurityUtils.getUser().getUsername();
        SseEmitterUtil.closeEmitter(SystemEnum.SERVANT.getSystem(), username);
        return R.ok();
    }
